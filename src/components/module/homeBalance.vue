<template>
    ...
    <div class="aside2">
            ...
            <div class="balance-info">
                ...
                <div class="balance-total">{{getBalance.balance}}</div>
            ...
            <div class="balance-button">
                ...
                <button type="button" class="topup-btn" style="margin-top:10px">
...
export default {
  name: 'Balance',
  methods: {
    ...mapActions({ getUserBalance: 'getBalance' }),
...
.balance, .balance-total, .user-number {
    margin-top: 10px;
}
